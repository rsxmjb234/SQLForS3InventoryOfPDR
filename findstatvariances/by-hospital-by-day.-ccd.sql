...
- Starts from lookup_stdev_average_for_hospitals to get the list of
  assigning authorities (hospitals), then counts CCDs from inventory.
- Includes ALL data paths and labels them: PROCESSED, ERROR, BACKLOG, or NORMAL.
- Handles key structures:
    processed/assigningAuthority/ccd/...
    error/assigningAuthority/ccd/...
    backload/assigningAuthority/ccd/...
    assigningAuthority/ccd/...
...
- Good for charting CCD activity per hospital over time, broken out by path type.
*/
